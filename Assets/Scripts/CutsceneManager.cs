...
{
    // Создаём Singleton для того чтобы легко обращаться к CutsceneManager через CutsceneManager.Instance.ПубличныйМетодКоторыйНужен()
    public static CutsceneManager Instance;

    // Лист из структур катсцен, в которых есть Key и Value которые в дальнейшем будут заполняться в Dictionary "cutsceneDataBase"
